...
[`agents/discovery_pipeline_agent.md`](agents/discovery_pipeline_agent.md) implements the 8-step workflow as an agentic loop: runs steps 1–3, 5–6, and 8 automatically; pauses at steps 4 ([INTERPRET]) and 7 ([PRIORITIZE]) for your authorship. Invoke via `/synthesis-discovery` slash command.
