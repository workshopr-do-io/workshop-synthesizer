...
│   ├── synthesis-help.md              /synthesis-help — index + decision tree
...
User invokes `/synthesis-discovery`.

```
1. Claude Code loads commands/synthesis-discovery.md
   ↓
2. The command file describes the recipe and references
   skills/synthesis-discovery/SKILL.md
   ↓
